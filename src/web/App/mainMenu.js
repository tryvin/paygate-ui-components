export default [
    {title: 'Principal', icon: 'bolt', items: [
    ...
    {title: 'Financeiro', icon: 'chart-bar', items: [
    ...
    {title: 'Caixa', icon: 'chart-bar', items: [
        {linkTo: '/finances', title: 'Principal', icon: 'chart-bar'},
    ...
    {title: 'Pessoas', icon: 'chart-bar', items: [
        {linkTo: '/finances', title: 'Principal', icon: 'chart-bar'},
    ...
    {title: 'Orçamentos', icon: 'chart-bar', items: [
        {linkTo: '/finances', title: 'Principal', icon: 'chart-bar'},
        {linkTo: '/finances/receipts', title: 'Adicionar', icon: 'balance-scale-left'},
